...
export const uiCopy = {
  zh: {
    ...
    newMaterial: {
      ...
      generateLink: "生成链接卡片",
      pasteCurrentLink: "粘贴当前链接",
      clipboardNotUrl: "剪贴板里不是有效链接。",
      clipboardUnavailable: "无法读取剪贴板，请手动粘贴链接。",
      generateFailed: "生成失败。",
      reading: "阅读中...",
      generating: "生成中...",
      recognizing: "识别中...",
  ...
  en: {
    ...
    newMaterial: {
      ...
      pasteCurrentLink: "Paste Current Link",
      clipboardNotUrl: "Clipboard does not contain a valid link.",
      clipboardUnavailable: "Cannot read clipboard. Paste the link manually.",
