...
export function CardEditor({ card, draft = false }: { card: SerializableCard; draft?: boolean }) {
  ...
  return (
    <section className="mt-6 min-w-0 space-y-4 rounded-lg border border-[#354039] bg-[#171d1a] p-4 text-[#f4f1e8] shadow-[0_1px_0_rgba(0,0,0,0.2)] sm:p-5">
      ...
      <div className="space-y-2 text-sm">
        ...
        <div className="min-w-0 rounded-md border border-[#354039] bg-[#101412] p-3">
          {concepts.length ? (
            <div className="mb-3 flex flex-wrap gap-2">
              {concepts.map((concept) => (
                <span
                  ...
                  className="inline-flex max-w-full items-center gap-2 rounded-md border border-[#354039] bg-[#171d1a] px-2.5 py-1.5 text-xs text-[#d8d2c6]"
                >
      ...
      {card.sourceUrl ? (
        <div className="min-w-0 rounded-md border border-[#354039] bg-[#101412] p-3 text-sm text-[#d8d2c6]">
